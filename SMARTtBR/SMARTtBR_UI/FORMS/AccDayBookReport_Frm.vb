...
Public Class AccDayBookReport_Frm
    ...
    Private Sub Fill_Details()
        Try
            ...
            Call Fill_ReportName(Cmb_ReportType, 6)
...
Invalid:
    ...
    Private Sub AccDayBookReport_Frm_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        Call SMARTtBR_MDI.Set_DeleteFromMenuListTable(Me.Tag)
    End Sub

    Private Sub AccDayBookReport_Frm_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles Me.KeyPress

        Call SendKeyTab(Me, Me.ActiveControl, e)

    End Sub
    Private Sub AccDayBookReport_Frm_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            Call Fill_Details()
            Call Clear_Controls()
        Catch ex As Exception
    ...
    Private Sub Cmd_Show_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Cmd_Show.Click
        Try
            ...
            M_Report = M_ReportsBL.ProcRpt_AccDayBookReport(Company_Code, Me.Tag, Cmb_ReportType.SelectedValue, User_ID, M_UnitFilterSw.ToString.Replace("DocumentElement", "NewDataSet"), Dtp_FromDt.Value, Dtp_ToDt.Value)
