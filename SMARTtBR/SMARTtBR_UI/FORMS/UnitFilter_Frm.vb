...
Public Class UnitFilter_Frm
    ...
    Private Sub UnitFilter_Frm_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles Me.KeyPress
    ...
    Public Sub Fill_UnitTreeView()
        Dim I As Integer
        Is_SetCurrentFilter = True
        Try
            Tvw_Unit.Nodes.Clear()
            M_TreeGroup_Tbl = M_UnitMasterTreeList
    ...
    Private Sub Tvw_Unit_KeyDown(sender As Object, e As KeyEventArgs) Handles Tvw_Unit.KeyDown
    ...
    Public Sub Set_CurrentFilter(ByVal M_UnitFilter_Tbl As DataTable)
        Is_SetCurrentFilter = True
        Try
            M_Filter_Tbl = M_UnitFilter_Tbl
