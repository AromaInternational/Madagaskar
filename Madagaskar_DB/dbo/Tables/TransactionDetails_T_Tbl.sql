...
GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'Cubic Centemeter', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'TransactionDetails_T_Tbl', @level2type = N'COLUMN', @level2name = N'MeasurementFinal_Value';
